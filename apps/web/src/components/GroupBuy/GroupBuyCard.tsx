    ...
    return (
        <Card className="p-4 border border-green-100 bg-white shadow-sm hover:shadow-md transition-shadow">
            <div className="flex justify-between items-start mb-3">
                <Badge variant={isSuccess ? "default" : "secondary"} className={isSuccess ? "bg-green-600 hover:bg-green-700" : "bg-orange-100 text-orange-700 hover:bg-orange-200"}>
